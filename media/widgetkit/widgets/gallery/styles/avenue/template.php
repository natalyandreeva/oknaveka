...
<?php if (count($images)) : ?>
<div id="gallery-<?php echo $widget_id; ?>" class="wk-slideshow wk-gallery-avenue" data-widgetkit="slideshow" data-options='<?php echo json_encode($settings); ?>'>
	<div>
		<ul class="slides">
        ...
        <?php if ($settings['buttons']): ?><div class="next w-icon-slider-right"></div><div class="prev w-icon-slider-left"></div><?php endif; ?>
