...
$(function() {
  $(selector + '[action = "/"]').submit(function(e) {
    ...
    hide_lbox = 0; // 1 - прятать лайтбокс при успешной отправке, класс лайтбокса должен быть 'lbox' (0 - не прятать)
    ...
    $.ajax({
      ...
      .done(function(result) {
        ...
        if(delay !== 0) {
          ...
          if(hide_lbox === 1 && result == 'success') $('.lbox').delay(delay).fadeOut();
        }
        if (result == 'success') {
