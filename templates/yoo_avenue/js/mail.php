...
$email = 'nataly.andreevaa@gmail.com'; // адрес куда отправлять письмо, можно несколько через запятую
...
$host = 'localhost'; // сервер отправки писем (приведен пример для Яндекса)
$username = ''; // логин вашего почтового ящика
$password = ''; // пароль вашего почтового ящика
$auth = 0; // нужна ли авторизация, 1 - нужна, 0 - не нужна
$secure = 'none'; // тип защиты
...
try {
  ...
  if($bcc !== ''){ $to_array = explode(',', $bcc); foreach ($to_array as $to){ $mail->AddBCC($to); }}
